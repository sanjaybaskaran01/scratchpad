...
<div id="paste-zone" class="max-w-3xl w-full mx-auto px-8 py-4">
  <!-- svelte-ignore a11y_click_events_have_key_events a11y_no_static_element_interactions -->
  <div
    class="bg-nb-card/50 border-2 border-dashed border-white/10 rounded-2xl py-20 flex flex-col items-center justify-center group hover:border-nb-accent/30 transition-colors cursor-pointer"
    onclick={openScratchpad}
  >
    <div class="paste-zone-pulse bg-nb-bg p-5 rounded-full mb-6">
      <span class="material-symbols-outlined text-nb-muted group-hover:text-nb-accent transition-colors" style="font-size:40px">edit_note</span>
    </div>
    ...
    <div class="flex items-center gap-4 mt-5 text-nb-muted font-mono text-xs">
